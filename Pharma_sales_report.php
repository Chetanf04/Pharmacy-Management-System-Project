...
<body>
    <nav class="head" style="height: 70px;">
      ...
      <i class="fa-solid fa-arrow-left"></i> Back to Dashboard
        ...
        <h2 style="color:white;font-size: 25px; font-weight:700">PHARMIST SALES REPORT</h2>
    </nav>

    <div class="container my-5">
        <form action="Pharma_sales_report.php?invoice_number=<?php echo $_GET['invoice_number'] ?? ''; ?>" method="POST" class="row justify-content-center g-3">
            <div class="col-md-4">
